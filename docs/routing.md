...
The scenario matrix in `evals/routing-scenarios.json` covers the required feature, bugfix, refactor, integration, planning, toolset, Unity, Go/Nakama, and critical-work routes. `evals/validate.ps1` enforces the anti-over-delegation invariants.
