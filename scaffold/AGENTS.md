...
Use the installed `lightflow` skill for software implementation, bug fixing, refactoring, integration, architecture, and planning requests. The primary agent acts as Orchestrator and selects among the Explorer, Architect, Worker, and Reviewer custom specialists; do not spawn another Orchestrator.
